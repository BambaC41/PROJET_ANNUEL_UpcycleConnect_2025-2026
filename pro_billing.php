...
<head>
    <meta charset="UTF-8">
    <title>Facturation Pro - UpcycleConnect</title>
...
<main class="pro-shell page-shell">
    ...
    <section class="pro-card">
        ...
        <!-- 🔥 NOUVEAUX BOUTONS STRIPE 🔥 -->
        <div class="row-actions page-actions" style="flex-wrap:wrap;gap:12px;">
            <a class="btn-primary" href="paiement_stripe.php?amount=2999&item=Abonnement+Premium">💰 Payer abonnement premium (29,99€)</a>
            <a class="btn-primary" href="paiement_stripe.php?amount=9900&item=Campagne+Publicitaire">📢 Payer campagne publicitaire (99,00€)</a>
        </div>
        ...
        <table class="table">
            <thead>
                <tr><th>Référence</th><th>Date</th><th>Montant</th><th>Statut</th></tr>
            </thead>
            <tbody>
