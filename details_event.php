...
<html lang="fr">
  ...
  $item = $items[$id] ?? null;
  $title = ($item ? $item['title'] : 'Détails Événement') . ' - UpcycleConnect'; 
    ...
    <main class="admin-layout">
      ...
      <section class="admin-content">
        <section class="admin-section">
          ...
          <? if ($item): ?>            
            <h1>Détails Événement : <? echo $item['title']; ?></h1>
        ...
        <div id="editModalContent" class="bg-white rounded-lg shadow-xl w-full max-w-lg overflow-hidden transform -translate-y-full transition-transform duration-300 ease-out">
          <div class="p-6">
            <div class="flex justify-between items-center pb-4 border-b border-gray-100 mb-4">
              <h5 class="text-xl font-bold text-brand-dark" id="modal-display-title">Modifier l'événement</h5>
            ...
            <form action="#" method="POST" class="flex flex-col m-0">
              <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div class="space-y-2">
                    <label for="modal-item-title" class="block text-sm font-bold text-gray-700 uppercase tracking-wider">Titre</label>
