...
<head>
    ...
    <title>Planning particulier - UpcycleConnect</title>
...
<main class="pro-shell page-shell">
    <section class="pro-card">
        ...
        <div class="schedule">
            <div class="schedule-grid">
                ...
                <?php foreach ($weekDays as $i => $day): ?>
                    <div class="schedule-day-head"><?= e($dayNames[$i] . '. ' . date('d/m/y', $day)) ?></div>
                <?php endforeach; ?>
        ...
        <table class="table">
            <thead>
                <tr><th>Session</th><th>Date</th><th>Prix</th><th>Paiement</th></tr>
            </thead>
            <tbody>
            <?php foreach ($inscriptions as $ins): ?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php else: ?>
                            <!-- 🔥 NOUVEAU LIEN STRIPE 🔥 -->
                            <a class="btn-primary" href="paiement_stripe.php?amount=<?= (float)($ins['prestation_prix'] ?? 0) * 100 ?>&item=Inscription+<?= urlencode($ins['prestation_titre'] ?? 'Evenement') ?>&inscription_id=<?= $iid ?>">
