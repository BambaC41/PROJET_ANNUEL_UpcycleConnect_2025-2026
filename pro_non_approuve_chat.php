...
if ($targetUser > 0 && $targetUser != $userId) {
    ...
    if ($convId) {
        header('Location: pro_non_approuve_chat.php?conv=' . $convId);
        exit;
    }
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['send_message'])) {
    ...
    if ($targetUserId > 0 && ($content !== '' || $filePath !== '')) {
        ...
        if (isset($result['conversation_id'])) {
            ...
            header('Location: pro_non_approuve_chat.php?conv=' . $result['conversation_id']);
            exit;
        }
    }
}
...
<head>
    ...
    <title>Chat - En attente de validation</title>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .pending-header .brand {
            font-weight: 700;
            color: #4caf50;
        }
        .pending-header .logout-btn {
            color: #f44336;
        ...
        .pending-header .logout-btn:hover {
...
<div class="pending-header">
    <span class="brand">UpcycleConnect Pro</span>
    <span>⏳ Votre compte professionnel est en attente de validation</span>
    <a href="logout.php" class="logout-btn">🔓 Déconnexion</a>
</div>
<div class="pending-warning">
    ⚠️ Vous pouvez utiliser la messagerie pour échanger avec l'administration.
    <strong>Téléchargez vos documents ici pour faciliter votre validation.</strong>
</div>
        ...
        <div class="chat-sidebar">
            ...
            <div class="chat-conversations" id="conversationsList">
                ...
                <?php else: ?>
                    ...
                    ?>
                        <a href="pro_non_approuve_chat.php?conv=<?= (int)$conv['id_conversation'] ?>" class="chat-conv-item <?= $isActive ? 'active' : '' ?>">
        ...
        fetch('chat_search_ajax.php?q=' + encodeURIComponent(query))
            ...
            .then(data => {
                ...
                data.forEach(user => {
                    ...
                    html += `
                        <a href="pro_non_approuve_chat.php?user=${user.id_user}" class="search-result-item">
                            <div class="chat-avatar">
