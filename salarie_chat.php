...
if ($targetUser > 0 && $targetUser != $userId) {
    ...
    if ($convId) {
        header('Location: salarie_chat.php?conv=' . $convId);
        exit;
    }
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['send_message'])) {
    ...
    if ($targetUserId > 0 && ($content !== '' || $filePath !== '')) {
        ...
        if (isset($result['conversation_id'])) {
            ...
            header('Location: salarie_chat.php?conv=' . $result['conversation_id']);
            exit;
        }
    }
}
...
<head>
    ...
    <title>Chat - Espace Salarié</title>
            ...
            <div class="chat-sidebar">
                ...
                <div class="chat-conversations" id="conversationsList">
                    ...
                    <?php else: ?>
                        ...
                        ?>
                            <a href="salarie_chat.php?conv=<?= (int)$conv['id_conversation'] ?>" class="chat-conv-item <?= $isActive ? 'active' : '' ?>">
        ...
        fetch('chat_search_ajax.php?q=' + encodeURIComponent(query))
            ...
            .then(data => {
                ...
                data.forEach(user => {
                    ...
                    html += `
                        <a href="salarie_chat.php?user=${user.id_user}" class="search-result-item">
                            <div class="chat-avatar">
