...
?>
<header class="navbar">
    <div class="logo"><a href="salarie.php" style="text-decoration:none;color:#16a34a;">UpcycleConnect Salarié</a></div>
    <nav class="auth-buttons">
        ...
        <a class="btn-outline" href="salarie_planning.php">🗓️ Planning</a>
